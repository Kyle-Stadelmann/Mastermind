...
## Timeline and Extra Information
...
## Goals
- Implement at least a basic form of mastermind using 10 rows, 6 colored pegs, no duplicate colors (for less complexity)
- Basic input (type first letter of color in order, enter to confirm, backspace to change)
- Simply end game with win/lose text after completion.
...
- Allow duplicate color button (changes key-peg and other logic)
